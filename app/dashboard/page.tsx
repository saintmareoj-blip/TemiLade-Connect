    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0F172A] to-[#1E293B] text-white p-4 pb-24">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-5 mb-6">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-white/20 p-3 rounded-xl font-semibold">
            + Fund Wallet
          </button>
          <button className="flex-1 bg-white/10 border border-white/20 p-3 rounded-xl font-semibold">
            🕒 History
          </button>
        </div>
      </div>
