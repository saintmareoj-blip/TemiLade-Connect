  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg p-6 mt-10">
        ...
        <button className="w-full mt-4 bg-green-500 text-white p-3 rounded-xl font-bold">Send Money</button>
        <button className="w-full mt-2 bg-gray-200 p-3 rounded-xl font-bold">Transaction History</button>
      </div>
    </div>
  );
}
